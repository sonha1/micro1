package com.gtel.warehouse.rabbitmq.producers;
...
public class WarehouseProducer {
    ...
    public void sendWarehouseSuccessMessage(HandleWarehouseSuccessEventMessage message) {
        rabbitTemplate.convertAndSend(successWarehouseExchange, successWarehouseRoutingKey, message);
    }

    public void sendWarehouseFailureMessage(HandleCreateOrderFailureEventMessage message) {
